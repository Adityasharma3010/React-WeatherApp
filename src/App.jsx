...
function App() {
  ...
  return (
    <div className="flex flex-col items-center justify-center relative min-h-screen px-4 bg-skygrid bg-starfield transition-all duration-300">
      <div className="fixed top-4 right-4 z-50">
        <DarkModeToggle />
      </div>

      <div className="dark:bg-black/90 bg-white/30 text-black/85 backdrop-blur-md z-3 border-white/30 dark:bg-white/5 dark:text-white rounded-lg shadow-lg px-4 py-4 sm:px-6 sm:py-5 md:px-8 md:py-6 max-w-sm w-full overflow-hidden">
